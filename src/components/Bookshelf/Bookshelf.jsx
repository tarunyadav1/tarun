      ...
      <Card className="Bookshelf" padding>
        <div className="Bookshelf__books__container">
          <div className="BookRowLabels">
            ...
            <Label
              category="table"
              className="BookRowLabel BookRowLabel--genre"
            >
              Genre
            </Label>
            <Label
              category="table"
              className="BookRowLabel BookRowLabel--status"
            >
              Status
            </Label>
          </div>
          ...
          <div className="Bookshelf__action__container">
            {expanded && (
              <p className="Bookshelf__action__message">
                I'm still digging through my <strong>read</strong> archive{" "}
                <span className="emoji--small" role="img" aria-label="emoji">
                  😊
                </span>
              </p>
            )}
            <Button
              className="Bookshelf__action__button"
              category="secondary"
