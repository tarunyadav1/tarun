  ...
  <Layout showNavigation showSocialCol showFooter>
    ...
    {/* <MaxWidth className="Home__recent">
      <div>
        ...
        <Link to="/" className="Home__recent__item Home__recent__item--project">
          <ContestantHead name="Deandra" />
          <div>
            <h3>Bachelor 2020 Contestant Guide</h3>
            <p>Hannah Ann, Madison, Kelley, oh my!</p>
          </div>
        </Link>
      </div>
      <div>
        ...
        >
          <div>
            ...
            <p>
              Collect and utilize the tools needed to spin up and edit a website
              on your computer. Basic HTML/CSS/JS, D3.js, and Twitter Bootstrap
              starters provided.
            </p>
          </div>
        </Link>
